...
Purity is virtually identical. NMI is slightly lower for Matryoshka, which finds different but equally valid cluster structures (ARI between the two clusterings is 0.48, meaning they agree on about half of point-pair groupings).
